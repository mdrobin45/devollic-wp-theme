            ...
            <div class="row">
               <div class="col-lg-8">
                  <div class="single-product-wrap">
                     <div class="thumb">
                        <img src="https://solverwp.com/demo/html/drketa/assets/img/product/1.png" alt="image" />
                        ...
                        <div class="tab-pane fade show active" id="pills-home">
                           ...
                           <ul>
                              ...
                              <li>
                                 ...
                                 <p>
                                    Create stunning slides with different
                                    animation effects easily with Slick Slider.
                                 </p>
                              </li>
                              <li>
                                 <p class="font-medium">
                                 ...
                                 <p>
                                    ...
                                    will run as it should be. Kettle template is
                                    fully responsive layout for all type of
                                    devices.
                                 </p>
                              </li>
                              <li>
                                 ...
                                 <p>
                                    Kettle template coded with beautiful and
                                    clean codes! Some powerful HTML files 100%
                                    valid W3 web standards.
                                 </p>
                              </li>
                           </ul>
                        </div>
                  ...
                  <div class="sidebar-area">
                     <div class="widget widget-cart">
                        <div class="widget-cart-inner text-center">
                           ...
                           <ul>
                              <li>
                                 <i class="fa fa-shopping-cart"></i>12 Sales
                              </li>
                     ...
                     <div class="widget widget-list">
                        <ul>
                           ...
                           <li>
                              <span>Compatible With</span>Bootstrap 4.x
                              <br />Included PHP Files, <br />HTML Files, CSS,
                              <br />JS Files
                           </li>
                           ...
                           <li>
                              <span>Tags</span>bakery, bar, blog, burger, cafe,
                              chef, food, grill, menu
                           </li>
                        </ul>
                     </div>
                  </div>
